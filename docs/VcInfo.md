...
**CreatedBy** | [***AllOfVcInfoCreatedBy**](AllOfVcInfoCreatedBy.md) | (任意) VC情報を生成したユーザーアカウント | [default to null]
**VcSchema** | [***AllOfVcInfoVcSchema**](AllOfVcInfoVcSchema.md) | (任意) 発行したVCの元となるVCスキーマ | [optional] [default to null]
**User** | [***AllOfVcInfoUser**](AllOfVcInfoUser.md) | (任意) VC情報と紐付いたアカウント | [optional] [default to null]
...
**Badge** | [***AllOfVcInfoBadge**](AllOfVcInfoBadge.md) | (任意) VC情報と紐付いたバッジ | [optional] [default to null]

...
type VerificationDto struct {
	...
	VcInfoId string `json:"vcInfoId,omitempty"`
	// (任意) 検証を実行するVP情報の識別子。VP情報の識別子を指定して検証を実行する場合は必須。
	VpInfoId string `json:"vpInfoId,omitempty"`
	// (任意) 検証を実行するVCのJSONテキストデータ。VCのJSONテキストデータを入力して検証を実行する場合は必須。
	VcObject *interface{} `json:"vcObject,omitempty"`
	// (任意) 検証を実行するVPのJSONテキストデータ。VPのJSONテキストデータを入力して検証を実行する場合は必須。
	VpObject *interface{} `json:"vpObject,omitempty"`
}
